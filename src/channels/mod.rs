...
struct ChannelRuntimeContext {
    ...
    tool_call_model: Option<String>,
    tool_call_model_tools: Vec<String>,
    ...
    let llm_result = tokio::select! {
        ...
        result = tokio::time::timeout(
            ...
            run_tool_call_loop(
                ...
                ctx.tool_call_model.as_deref(),
                ctx.tool_call_model_tools.as_ref(),
...
pub async fn start_channels(config: Config) -> Result<()> {
    ...
    let runtime_ctx = Arc::new(ChannelRuntimeContext {
        ...
        tool_call_model: config.agent.tool_call_model.clone(),
        tool_call_model_tools: config.agent.tool_call_model_tools.clone(),
...
BTC is currently around $65,000 based on latest tool output."#
    ...
    async fn process_channel_message_telegram_keeps_system_instruction_at_top_only() {
        ...
        let mut histories = HashMap::new();
        histories.insert(
            "telegram_thread-1_alice".to_string(),
            vec![
